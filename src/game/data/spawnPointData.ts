...
export const SPAWN_POINT_DATA: readonly SpawnPointDefinition[] = [
  { id: 'sp-shallow-goldfish-a', x: 600, y: 160, fishId: 'goldfish-orange', maxAlive: 1, swimRange: 320 },
  { id: 'sp-shallow-minnow-a', x: 1420, y: 140, fishId: 'slender-blue-white', maxAlive: 1, swimRange: 780 },
  ...
  { id: 'sp-edit-10', x: 500, y: 220, fishId: 'goldfish-orange', maxAlive: 1, swimRange: 360 },
  { id: 'sp-edit-11', x: 620, y: 280, fishId: 'goldfish-orange', maxAlive: 1, swimRange: 360 },
