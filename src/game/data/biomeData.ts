...
export const BIOME_DATA: readonly BiomeDefinition[] = [
  {
    ...
    fogOpacity: 0.0,
    lightMultiplier: 1.0,
    fishIds: ['goldfish-orange', 'slender-blue-white', 'greenish-brown', 'blue-tang'],
    propIds: ['reed', 'pebble'],
  },
  {
    id: 'kelp-forest',
    ...
    fishIds: ['slender-blue-white', 'blue-tang', 'olive-pike', 'pink-round', 'purple-chunky'],
    propIds: ['kelp', 'rock'],
  },
  {
    id: 'twilight-waters',
    ...
    fogOpacity: 0.22,
    lightMultiplier: 0.6,
    fishIds: ['pink-round', 'purple-chunky', 'blue-tuna', 'grey-catfish'],
  ...
  },
  {
    ...
    fogOpacity: 0.34,
    lightMultiplier: 0.4,
    fishIds: ['blue-tuna', 'grey-catfish'],
    propIds: ['vent', 'bone'],
  },
  {
